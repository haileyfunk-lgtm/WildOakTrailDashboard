<?php
// Replaces the compare-table widget's html with the version that has
// "Expectations" instead of "Feature" and the swipe-hint/scrollbar markup.
...
echo "Updated compare-table widget html (v2).\n";
